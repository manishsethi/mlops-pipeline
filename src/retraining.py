...
class ModelRetrainingSystem:
    ...
    def check_performance_drift(self):
        ...
        try:
            ...
            if recent_performance < self.performance_threshold:
                self.logger.warning(f"Performance drift detected: {recent_performance:.3f} < {self.performance_threshold}")
    ...
    def _calculate_recent_performance(self, df):
        ...
        avg_response_time = df['response_time'].mean() if 'response_time' in df.columns else 0.1
    ...
    def _validate_new_model(self, model):
        ...
        try:
            ...
            if self.model_type == 'classification':
                ...
                test_input = np.array([[8.3252, 41., 6.98, 1.02, 322., 2.56, 37.88, -122.23]])
